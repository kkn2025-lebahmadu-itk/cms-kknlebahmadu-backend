"""
Django settings for kkn_backend project.
...
SECRET_KEY = 'django-insecure-656br40^+nvoufuu(&*7q_%n95h8_aw!2&jsvvunis8d1$p89^'
...
WSGI_APPLICATION = 'kkn_backend.wsgi.application'
