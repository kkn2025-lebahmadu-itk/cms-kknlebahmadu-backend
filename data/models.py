...
class LetterRecap(models.Model):
    tipe_surat = models.CharField(max_length=20, null=True, blank=True)
    tanggal_surat = models.DateField()
    nomor_surat = models.CharField(max_length=20, null=True, blank=True)
    keperluan = models.TextField()
    created_at = models.DateField(auto_now_add=True)

    def __str__(self):
        return f"{self.nomor_surat} - {self.tanggal_surat}"